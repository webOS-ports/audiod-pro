...
public:
    ...
    ModuleInterface * getCurrentVolumeModule ();
    ...
    ModuleInterface * getExplicitVolumeControlModule ();
    bool setLockedVolumeModule (ModuleInterface *module);
    ...
    bool checkPhoneScenario(ModuleInterface *phone) ;
...
private:
    ...
    ETTYMode            mTTYMode;
    bool                mHAC;
    ModuleInterface*    mLockedVolumeModule;
